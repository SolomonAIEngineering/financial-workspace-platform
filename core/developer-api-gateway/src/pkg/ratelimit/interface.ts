...
export const ratelimitRequestSchema = z.object({
  ...
  /**
   * If true, the ratelimit will be applied asynchronously.
   * This means that the ratelimit will be applied after the request has been processed.
   * This is useful for ratelimits that are applied at the edge.
   */
