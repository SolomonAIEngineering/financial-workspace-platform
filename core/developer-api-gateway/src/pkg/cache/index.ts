...
export function initCache(
  ...
  const cloudflare:
    | Store<CacheNamespace, CacheNamespaces[CacheNamespace]>
    | undefined =
  ...
  return createCache({
    keyById: new Namespace<CacheNamespaces['keyById']>(
      c.executionCtx,
      defaultOpts,
    ),
    ...
    apiById: new Namespace<CacheNamespaces['apiById']>(
      c.executionCtx,
      defaultOpts,
    ),
    keysByOwnerId: new Namespace<CacheNamespaces['keysByOwnerId']>(
      c.executionCtx,
      defaultOpts,
    ),
    verificationsByKeyId: new Namespace<
      CacheNamespaces['verificationsByKeyId']
    >(c.executionCtx, defaultOpts),
    ratelimitByIdentifier: new Namespace<
      CacheNamespaces['ratelimitByIdentifier']
    >(c.executionCtx, defaultOpts),
    keysByApiId: new Namespace<CacheNamespaces['keysByApiId']>(
      c.executionCtx,
      defaultOpts,
    ),
    identityByExternalId: new Namespace<
      CacheNamespaces['identityByExternalId']
    >(c.executionCtx, defaultOpts),
