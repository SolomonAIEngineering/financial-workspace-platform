...
describe.each<TestCase>([
  ...
  },
  {
    ...
    query: buildQuery(({ or, and }) =>
      and('p1', or('p2', 'p6', and('p4', 'p2'))),
    ),
    expected: { status: 200, valid: true },
  },
  {
  ...
  },
  {
    ...
    query: buildQuery(({ and, or }) =>
      or(and('p1', or('p2', and('p3', 'p4'))), and('p5', 'p6')),
    ),
    roles: [{ name: 'r1', permissions: ['p1', 'p2', 'p3', 'p4', 'p5', 'p6'] }],
    expected: { status: 200, valid: true },
  },
  {
    ...
    query: buildQuery(({ and, or }) =>
      or(and('p1', or('p7', and('p3', 'p4'))), and('p5', 'p7')),
    ),
