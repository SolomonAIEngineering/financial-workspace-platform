    ...
    <section className="relative">
        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,var(--color-slate-800),transparent)1] md:py-20">
          ...
          <div className="-m-5 mx-auto grid max-w-xs gap-6 md:max-w-none md:grid-cols-3 lg:gap-10">
            ...
            <div className="p-5 text-center">
              <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full border border-transparent [background:linear-gradient(var(--color-slate-800),var(--color-slate-800))_padding-box,conic-gradient(var(--color-slate-400),var(--color-slate-700)_25%,var(--color-slate-700)_75%,var(--color-slate-400)_100%)_border-box]">
      ...
      <div className="relative px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl py-12 md:py-20">
          <h3 className="h3 bg-linear-to-r inline-flex from-slate-200/60 via-slate-200 to-slate-200/60 bg-clip-text pb-8 text-transparent md:pb-16">
            Open positions
          </h3>
          <div className="space-y-8">
            {items.map((item, index) => (
              <div key={index}>
                <h4 className="bg-linear-to-r inline-flex from-purple-500 to-purple-200 bg-clip-text pb-3 font-medium text-transparent">
                  {item.area}
                </h4>
