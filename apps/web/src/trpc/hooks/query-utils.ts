 ...
 * 
 * This function is used to get the query client instance from the global context
 * when inside a component. Outside a component, it will return undefined.
 */
 ...
 */
export function buildQueryKey(path: string[], params: Record<string, any> = {}): unknown[] {
 ...
 */
export function invalidateQueries(queryClient: QueryClient, path: string[]): Promise<void> {
 ...
 */
export function refetchQueries(queryClient: QueryClient, path: string[]): Promise<void> {
 ...
 */
export function cancelQueries(queryClient: QueryClient, path: string[]): Promise<void> {
