 ...
 *
 * This schema defines the structure and validation rules for accepting a team
 * invite:
 *
 ...
 *   before allowing the operation. It validates the invite code against the
 *   acceptTeamInviteSchema before processing the acceptance through the tRPC
 *   API.
 *
 *   After a successful acceptance, it revalidates the teams page to ensure the UI
