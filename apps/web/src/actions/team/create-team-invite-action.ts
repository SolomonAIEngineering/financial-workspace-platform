 ...
 * 
 * This schema defines the structure and validation rules for creating a team invite:
 ...
 * 
 * This authenticated action handles creating an invitation for a user to join a team.
 * 
 * @remarks
 * The action uses the authActionClient to ensure the user is authenticated before
 * allowing the operation. It validates all input against the createTeamInviteSchema
 * before processing the invite creation through the tRPC API.
 * 
 * After a successful creation, it revalidates the team page to ensure the UI reflects
 * the latest information.
 * 
 * @param ctx - The context object containing the authenticated user
 * @param parsedInput - The validated input data matching the createTeamInviteSchema
 * 
