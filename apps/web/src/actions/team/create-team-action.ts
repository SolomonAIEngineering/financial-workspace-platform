 ...
 * 
 * This schema defines the structure and validation rules for creating a new team:
 ...
 * 
 * This authenticated action handles the creation of a new team and automatically
 * assigns the current user as the team owner.
 * 
 * @remarks
 * The action uses the authActionClient to ensure the user is authenticated before
 * allowing the team creation. It validates all input against the createTeamSchema
 * before processing the creation through the tRPC API.
 * 
 * After a successful creation, it revalidates the teams page to ensure the UI reflects
