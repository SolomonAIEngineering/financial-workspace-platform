 ...
 * 
 * This schema defines the structure and validation rules for updating a user's role:
 ...
 * allowing the operation. It validates all input against the updateUserRoleSchema
 ...
 * @param parsedInput - The validated input data matching the updateUserRoleSchema
 * 
