 ...
 *
 * This schema defines the structure and validation rules for adding a user to a
 * team:
 *
 ...
 *
 * This authenticated action handles adding a user to a team with a specified
 * role.
 *
 * @remarks
 ...
 *   addUserToTeamSchema before processing the addition through the tRPC API.
 *
 *   After a successful addition, it revalidates the team page to ensure the UI
