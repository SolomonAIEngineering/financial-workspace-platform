 ...
 *
 * This schema defines the structure and validation rules for removing a user
 * from a team:
 *
 ...
 *   removeUserFromTeamSchema before processing the removal through the tRPC
 *   API.
 *
 *   After a successful removal, it revalidates the team page to ensure the UI
