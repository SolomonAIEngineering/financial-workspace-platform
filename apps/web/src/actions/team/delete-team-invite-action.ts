 ...
 *
 * This authenticated action handles deleting an invitation for a user to join a
 * team.
 *
 * @remarks
 ...
 *   deleteTeamInviteSchema before processing the invite deletion through the
 *   tRPC API.
 *
 *   After a successful deletion, it revalidates the team page to ensure the UI
