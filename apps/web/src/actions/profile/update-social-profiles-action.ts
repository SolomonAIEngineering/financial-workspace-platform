 ...
 * 
 * This authenticated action handles updates to a user's social media profiles, including
 * GitHub, LinkedIn, and Twitter links. It validates all input against the socialProfilesSchema
 ...
 * @param parsedInput - The validated input data matching the socialProfilesSchema
 * 
