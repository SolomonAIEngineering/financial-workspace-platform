 ...
 * 
 * This schema defines the structure and validation rules for user contact information:
 ...
 * - addressLine2: Optional secondary address line with max length of 255 characters
 * - businessEmail: Optional business email that must be a valid email format
 * - businessPhone: Optional business phone number with max length of 50 characters
...
const contactInfoSchema = z.object({
    ...
    businessEmail: z.string().email('Invalid business email').max(255).optional().nullable(),
 ...
 * allowing the update. It revalidates the profile page after a successful update
 ...
 * 
 * @throws Will not throw directly, but catches and returns errors as part of the response
 */
