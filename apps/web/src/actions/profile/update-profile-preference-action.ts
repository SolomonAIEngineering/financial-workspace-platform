 ...
 *
 * This authenticated action handles updates to a user's preferences, including
 * display settings, document settings, and notification preferences. It
 * validates all input against the userPreferencesSchema before processing.
 *
 * @remarks
 *   The action uses the authActionClient to ensure the user is authenticated
 *   before allowing the update. It processes all preference fields defined in
 *   the userPreferencesSchema, making it suitable for complete preference
 *   updates or partial updates of specific sections.
 *
 ...
 *   - DocumentPreferences: Document handling settings like auto-save and default
 *       view
