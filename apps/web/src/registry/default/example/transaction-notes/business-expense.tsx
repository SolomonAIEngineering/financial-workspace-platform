...
export const businessExpenseTemplate: Value = [
  {
    type: 'h2',
    children: [{ text: 'Business Expense Documentation' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'h3',
    children: [{ text: 'Expense Classification' }],
  },
  {
    type: 'p',
  ...
  {
    type: 'p',
    children: [{ text: 'Cost Center/Department: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Expense Details' }],
  },
  {
    type: 'p',
    children: [{ text: 'Date Incurred: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [{ text: 'Vendor/Merchant: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'p',
    children: [{ text: 'Currency: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Authorization & Compliance' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'p',
    children: [{ text: 'Approved By: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
  ...
  },
  {
    type: 'p',
    indent: 1,
    children: [{ text: 'Explanation if non-compliant: ' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Participants & Business Context' }],
  },
  {
    type: 'p',
    children: [{ text: 'Attendees/Participants: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'p',
    children: [{ text: 'Business Outcome: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Tax & Accounting Information' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Tax Category: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Percentage Deductible: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'GL Account Number: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  {
    type: 'h3',
    children: [{ text: 'Documentation & Receipts' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    listStart: 2,
    listStyleType: 'decimal',
    children: [{ text: 'Receipt/Invoice #: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  {
    type: 'h3',
    children: [{ text: 'Reimbursement Details' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Reimbursable: ', bold: true }, { text: '☐ Yes  ☐ No' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Reimbursement Date: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  {
    type: 'h3',
    children: [{ text: 'Processing (Finance Team Use)' }],
  },
  {
    type: 'p',
