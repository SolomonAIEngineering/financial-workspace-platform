...
export const financialReviewTemplate: Value = [
    {
        type: 'h2',
        children: [
            { text: 'Financial Review & Audit Documentation' },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        type: 'p',
        children: [
            { text: 'Issues Identified: ', bold: true },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        type: 'p',
        children: [
            { text: 'Corrective Actions Needed: ', bold: true },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        type: 'p',
        children: [
            { text: 'Action Assignee: ', bold: true },
            { text: '' },
        ],
    },
    {
    ...
    },
    {
        type: 'p',
        children: [
            { text: 'Policy Recommendations: ', bold: true },
            { text: '' },
        ],
    },
    {
    ...
    },
    {
        type: 'p',
        children: [
            { text: 'Resolution Date: ', bold: true },
            { text: '' },
        ],
    },
    {
