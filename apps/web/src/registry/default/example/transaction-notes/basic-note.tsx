...
export const basicNoteTemplate: Value = [
  {
    type: 'h2',
    children: [{ text: 'Transaction Overview' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'p',
    children: [{ text: 'Date Recorded: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
  ...
  {
    type: 'p',
    children: [{ text: 'Transaction Category: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [{ text: 'Associated Department: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Financial Details' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Budget Code: ' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Account Number: ' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'GL Category: ' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Tax Status: ' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Invoice/Reference #: ' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Approvals & Verification' }],
  },
  {
    type: 'p',
    children: [{ text: 'Authorized By: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'h3',
    children: [{ text: 'Record Keeping' }],
  },
  {
    type: 'p',
    children: [{ text: 'Document Links: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [
