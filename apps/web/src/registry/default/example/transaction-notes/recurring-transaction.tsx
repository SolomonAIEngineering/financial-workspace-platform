...
export const recurringTransactionTemplate: Value = [
  {
    type: 'h2',
    children: [{ text: 'Recurring Transaction Management' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'h3',
    children: [{ text: 'Subscription Information' }],
  },
  {
    type: 'p',
    children: [{ text: 'Service Provider/Vendor: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    children: [
  ...
  {
    type: 'p',
    children: [{ text: 'Account Number/ID: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Payment Schedule' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Payment Amount: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Payment Method: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Subscription Status' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    listStart: 3,
    listStyleType: 'decimal',
    children: [{ text: 'Contract End Date: ', bold: true }, { text: '' }],
  },
  {
    type: 'p',
    indent: 1,
    listStart: 4,
    listStyleType: 'decimal',
    children: [{ text: 'Notice Period Required: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Budget & Accounting' }],
  },
  {
    type: 'p',
  ...
  {
    type: 'p',
    children: [{ text: 'GL Account: ', bold: true }, { text: '' }],
  },
  {
    type: 'h3',
    children: [{ text: 'Notes & Reminders' }],
  },
  {
    type: 'p',
    indent: 1,
  ...
  },
  {
    ...
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Price Change History: ' }],
  },
  {
    type: 'p',
    indent: 1,
    listStyleType: 'disc',
    children: [{ text: 'Cancellation Instructions: ' }],
  },
  {
    type: 'callout',
    variant: 'info',
