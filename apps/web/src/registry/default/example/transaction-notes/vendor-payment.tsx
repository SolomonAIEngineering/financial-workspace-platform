...
export const vendorPaymentTemplate: Value = [
    {
        type: 'h2',
        children: [
            { text: 'Vendor Payment Documentation' },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        type: 'h3',
        children: [
            { text: 'Payment Method & Processing' },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        ...
        listStyleType: 'disc',
        children: [
            { text: 'Transaction Date: ', bold: true },
            { text: '' },
        ],
    },
    {
        ...
        listStyleType: 'disc',
        children: [
            { text: 'Processing Batch: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'h3',
        children: [
            { text: 'Invoice & Order Details' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Purchase Order #: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Contract Reference: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Products/Services: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Department/Cost Center: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'h3',
        children: [
            { text: 'Accounting Classification' },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        ...
        listStyleType: 'disc',
        children: [
            { text: 'Budget Line Item: ', bold: true },
            { text: '' },
        ],
    },
    {
    ...
    },
    {
        ...
        listStyleType: 'decimal',
        children: [
            { text: 'Receipt Verified By: ', bold: true },
            { text: '' },
        ],
    },
    {
    ...
    },
    {
        type: 'h3',
        children: [
            { text: 'Notes & Follow-up Items' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Special Instructions: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Issues/Discrepancies: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Required Actions: ', bold: true },
            { text: '' },
        ],
    },
    {
