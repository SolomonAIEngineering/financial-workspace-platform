...
export const disputeDocumentationTemplate: Value = [
    {
        type: 'h2',
        children: [
            { text: 'Transaction Dispute Documentation' },
        ],
    },
    {
        type: 'p',
    ...
    },
    {
        type: 'p',
        children: [
            { text: 'Amount in Dispute: ', bold: true },
            { text: '' },
        ],
    },
    {
        type: 'p',
        children: [
            { text: 'Merchant/Counterparty: ', bold: true },
            { text: '' },
        ],
    },
    {
    ...
    },
    {
        ...
        listStyleType: 'disc',
        children: [
            { text: 'Provisional Credit Received: Yes/No' },
        ],
    },
    {
        type: 'p',
        ...
        listStyleType: 'disc',
        children: [
            { text: 'Date of Provisional Credit: ' },
        ],
    },
    {
        type: 'p',
