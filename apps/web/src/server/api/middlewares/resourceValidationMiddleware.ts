import {
  ResourceType,
  resourceValidator,
} from '@/server/services/payment-tier';

import { TRPCError } from '@trpc/server';
import { t } from '../trpc';

/**
 * Creates a middleware for validating resource limits based on user's
 * subscription tier
 *
      ...
      switch (options.resourceType) {
        ...
        case ResourceType.STORAGE:
          if (options.getSize && typeof input === 'object') {
            ...
            await resourceValidator.validateStorageUsage(
              ctx.userId,
              storageSize
            );
          } else {
        ...
        case ResourceType.TEAM_MEMBER:
          if (options.teamId && typeof input === 'object') {
            ...
            if (teamId) {
              ...
              await resourceValidator.validateTeamMemberAddition(
                ctx.userId,
                teamId,
                1
              );
