 ...
 * UseEnterSubmit Hook
 * 
 * This hook provides functionality to submit a form when the Enter key is pressed
 * in a textarea element, without creating a new line.
 * 
 * @remarks
 * The hook handles common edge cases:
 * - Prevents form submission when Shift+Enter is pressed (allows for new lines)
 * - Prevents form submission during IME composition (for languages like Chinese, Japanese)
...
export function useEnterSubmit(): {
   ...
   * Submits the form when Enter is pressed without Shift and not during composition
   * 
