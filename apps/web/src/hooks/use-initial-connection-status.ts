 ...
 * 
 * @remarks
 * The hook integrates with trigger.dev's real-time run tracking to monitor connection jobs.
 * It automatically handles state transitions based on the connection's progress and completion status.
 * 
 * The hook maintains the current status of the connection (syncing, completed, failed)
 ...
 * @param props.accessToken - Authentication token for accessing the connection service
 * 
 * @returns An object containing:
 * - status: Current status of the connection (SYNCING, COMPLETED, FAILED, or null)
