 ...
 * 
 * This hook manages URL query parameters for tracking and filtering functionality,
 * providing a type-safe interface for reading and updating query parameters.
 * 
 * @remarks
 * The hook leverages nuqs for query state management, handling various parameter types:
 ...
 * 
 * It automatically handles serialization/deserialization of parameters and maintains
 * state synchronization with the URL.
 * 
 * @param initialDate - Optional initial date string to use as default if no date is specified in URL.
 *                      If not provided, defaults to the current date in ISO format (YYYY-MM-DD).
 * 
