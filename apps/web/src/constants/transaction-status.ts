/**
 * Transaction status constants for the financial management platform
 * These statuses represent the various states a transaction can be in
 * throughout its lifecycle, including approval workflows.
 */
 ...
 */
export const TransactionStatusMetadata: Record<TransactionStatus, {
    label: string;
    badgeType: 'default' | 'success' | 'warning' | 'destructive' | 'outline' | 'secondary';
    description: string;
    ...
    [TransactionStatus.PENDING]: {
        label: 'Pending',
        badgeType: 'warning',
        description: 'Transaction has been recorded but not confirmed by the financial institution',
        canTransitionTo: [TransactionStatus.COMPLETED, TransactionStatus.AWAITING_REVIEW, TransactionStatus.FLAGGED],
    ...
    [TransactionStatus.COMPLETED]: {
        ...
        canTransitionTo: [TransactionStatus.AWAITING_REVIEW, TransactionStatus.RECONCILED, TransactionStatus.FLAGGED, TransactionStatus.DISPUTED],
        requiresApproval: false
    },
    [TransactionStatus.AWAITING_REVIEW]: {
        ...
        canTransitionTo: [TransactionStatus.UNDER_REVIEW, TransactionStatus.APPROVED, TransactionStatus.REJECTED, TransactionStatus.NEEDS_DOCUMENTATION],
    ...
    [TransactionStatus.UNDER_REVIEW]: {
        ...
        canTransitionTo: [TransactionStatus.APPROVED, TransactionStatus.REJECTED, TransactionStatus.NEEDS_DOCUMENTATION, TransactionStatus.REQUIRES_APPROVAL],
        requiresApproval: true
    },
    [TransactionStatus.APPROVED]: {
        ...
        canTransitionTo: [TransactionStatus.RECONCILED, TransactionStatus.FLAGGED, TransactionStatus.DISPUTED],
        requiresApproval: false
    },
    [TransactionStatus.REJECTED]: {
        ...
        canTransitionTo: [TransactionStatus.UNDER_REVIEW, TransactionStatus.DISPUTED, TransactionStatus.NEEDS_DOCUMENTATION],
        requiresApproval: false
    },
    ...
    [TransactionStatus.DISPUTED]: {
        ...
        canTransitionTo: [TransactionStatus.APPROVED, TransactionStatus.REJECTED, TransactionStatus.COMPLETED],
        requiresApproval: true
    },
    [TransactionStatus.NEEDS_DOCUMENTATION]: {
        label: 'Needs Documentation',
        badgeType: 'warning',
        description: 'Transaction requires additional documentation before it can be processed',
        canTransitionTo: [TransactionStatus.UNDER_REVIEW, TransactionStatus.APPROVED, TransactionStatus.REJECTED],
        requiresApproval: true
    },
    ...
    [TransactionStatus.PARTIALLY_RECONCILED]: {
        ...
        badgeType: 'warning',
        description: 'Transaction has been partially reconciled with financial statements',
        canTransitionTo: [TransactionStatus.RECONCILED, TransactionStatus.DISPUTED, TransactionStatus.FLAGGED],
        requiresApproval: false
    },
    [TransactionStatus.VERIFIED]: {
        ...
        canTransitionTo: [TransactionStatus.DISPUTED, TransactionStatus.FLAGGED, TransactionStatus.RECONCILED],
        requiresApproval: false
    },
    [TransactionStatus.UNVERIFIED]: {
        ...
        canTransitionTo: [TransactionStatus.VERIFIED, TransactionStatus.FLAGGED, TransactionStatus.NEEDS_DOCUMENTATION],
        requiresApproval: true
    }
};
...
export const isStatusTransitionAllowed = (
    ...
    return TransactionStatusMetadata[currentStatus].canTransitionTo.includes(newStatus);
};

/**
 * Helper function to get an appropriate badge type for a status
 */
export const getStatusBadgeType = (status: string): 'default' | 'success' | 'warning' | 'destructive' | 'outline' | 'secondary' => {
