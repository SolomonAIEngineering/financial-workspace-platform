...
export function ClientTransactionsTable({ initialData }: ClientTransactionsTableProps = {}) {
    ...
    const { data: queryData, isPending } = api.transactions.getTransactions.useQuery(
        {
            page,
            limit: pageSize,
        },
    ...
    const transactions = (() => {
        ...
        if (effectiveData.transactions && Array.isArray(effectiveData.transactions)) {
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    <div className="rounded-full bg-muted p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground">
                            ...
                            <path d="M8 14h8"></path><rect width="16" height="16" x="4" y="4" rx="2"></rect>
                        </svg>
                    </div>
                    <h3 className="mt-4 text-lg font-medium">No transactions found</h3>
                    <p className="mt-2 max-w-md text-center text-sm text-muted-foreground">
                        There are no transactions in your account yet. They will appear here once you have financial activity.
                    </p>
                </div>
            )}
