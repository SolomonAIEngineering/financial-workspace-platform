        ...
        <div className="flex h-screen flex-col overflow-hidden">
            ...
            <div className="flex-grow overflow-hidden">
                {!hasAccounts ? (
                    ...
                    <div className="h-full overflow-hidden bg-white lg:relative lg:flex dark:bg-gray-900">
                        {/* Content */}
                        <div className="no-scrollbar mx-auto h-full w-full max-w-[96rem] overflow-auto px-4 py-8 sm:px-6 lg:px-8">
