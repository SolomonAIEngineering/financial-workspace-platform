    ...
    component: (props: Option) => {
      ...
      return (
        <div className="flex w-full max-w-28 items-center justify-between gap-2 font-mono">
          <span className="text-foreground/70 capitalize group-hover:text-accent-foreground">
            {props.label}
          </span>
...
export const sheetFields = [
  ...
  },
  {
    ...
    component: (props) => (
      <CopyToClipboardContainer className="rounded-md border border-destructive/50 bg-destructive/30 p-2 font-mono text-sm break-all whitespace-pre-wrap">
