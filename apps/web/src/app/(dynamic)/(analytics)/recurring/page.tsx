...
export const metadata = {
    ...
    description: "Manage your recurring transactions, subscriptions, and scheduled payments",
};
                ...
                <div className="relative z-10 space-y-2">
                    ...
                    <div className="ml-10">
                        <p className="text-muted-foreground max-w-2xl">
                            Track and manage your recurring transactions, subscriptions, bills, and scheduled payments. Monitor payment schedules and manage your cash flow.
                        </p>
                ...
                <div className="relative z-10">
                    <Suspense fallback={
                        <div className="p-8 flex flex-col items-center justify-center min-h-[400px]">
                            ...
                            <div className="mt-4 text-sm text-muted-foreground animate-pulse">Loading recurring transactions...</div>
                        </div>
                    }>
