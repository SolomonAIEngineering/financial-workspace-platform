...
/**
 * This is an example of a scheduled job that runs every day at midnight It
 * demonstrates how to use the Trigger.dev SDK to create scheduled jobs
 */
client.defineJob({
  ...
  run: async (payload, io, ctx) => {
    await io.logger.info('Running scheduled job', {
