...
console.info('Financial Engine SDK Configuration:', {
  ...
  usingDefaults: !process.env.API_SECRET_KEY || !process.env.FINANCIAL_ENGINE_BASE_URL,
...
export const engine = new FinancialEngine({
  ...
  baseURL:
    process.env.FINANCIAL_ENGINE_BASE_URL ?? "https://engine.solomon-ai-platform.com",
});