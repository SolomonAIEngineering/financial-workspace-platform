 ...
 *
 * This component shows different configuration options for the
 * ConnectTransactionsButton and includes the ConnectTransactionsProvider to
        ...
        <div className="mt-8 rounded-lg border bg-muted p-4">
          ...
          <ul className="list-inside list-disc space-y-2 text-sm">
            ...
            <li>
              ...
              anywhere you need a button to open the modal
            </li>
            <li>
              The button directly controls the modal state through React
              context, no URL parameters needed
            </li>
            <li>
              Customize the button appearance using the{' '}
              <code className="rounded bg-muted-foreground/20 px-1">
                buttonProps
              </code>{' '}
              property
