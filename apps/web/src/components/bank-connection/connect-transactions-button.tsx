 ...
 *
 * @property countryCode - The country code to use for institution search
 *   (default: 'US')
 ...
 * ConnectTransactionsModal with the specified country code and user ID. The
 * button's appearance and behavior can be customized using the buttonProps
 * property.
 *
 * @example
 *   // Basic usage
