 ...
 *
 * Displays a dropdown with all available teams, highlighting the user's role in
 * each team and showing team avatars.
 *
 * @example
 *   ```tsx
 *   <TeamSelector
            ...
            <SelectItem key={team.id} value={team.id}>
              <div className="flex items-center gap-2">
                ...
                {getUserRoleInTeam(team.id) === 'OWNER' && (
                  <Badge
                    variant="outline"
                    className="ml-1 rounded-sm px-1 py-0 text-xs"
                  >
                    Owner
                  </Badge>
                )}
