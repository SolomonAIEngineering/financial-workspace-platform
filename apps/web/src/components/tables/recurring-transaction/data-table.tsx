...
/**
 * @file data-table.tsx
 * @description Implements a specialized data table for recurring transactions.
 * This component extends the generic DataTable pattern with recurring transaction-specific
 ...
 * @returns A React component that displays a data table for recurring transactions
 * 
 * @example
 * ```tsx
 * <DataTable
...
export function DataTable<TData, TValue, TMeta = Record<string, unknown>>({
    ...
    }, [setSearchParams, searchParams, defaultColumnFilters, defaultColumnVisibility, defaultColumnSorting]);
                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-sm font-medium mb-3">Status & Type</h3>
                                <DataTableFilterControls />
                            </div>
                            <div>
                                <h3 className="text-sm font-medium mb-3">Amount & Date Ranges</h3>
                                <div className="space-y-2">
                                    {/* Ranges will appear here based on type */}
                                </div>
                            </div>
                            <div className="text-xs text-muted-foreground pt-4 border-t border-gray-200">
