 ...
 * @description Defines URL search parameter parsing logic for recurring transactions.
...
/**
 * Configuration object for all search parameters used in recurring transactions.
