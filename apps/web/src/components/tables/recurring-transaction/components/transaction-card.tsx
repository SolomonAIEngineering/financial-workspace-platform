...
/**
 * A modern, visually appealing card component for displaying recurring transaction details.
 * This component serves as a summary view in list contexts.
 */
            ...
            <div className="ml-2">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 border-t border-gray-100 pt-3">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs text-gray-600 truncate">{merchantName || 'Unknown'}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs text-gray-600">{frequency || 'Unknown frequency'}</span>
                    </div>
                </div>
            </div>
        </div>
