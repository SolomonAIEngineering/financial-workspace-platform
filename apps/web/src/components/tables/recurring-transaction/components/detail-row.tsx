...
/**
 * A modern, visually appealing component for displaying key-value pairs in
 * detail views. Includes support for various formatting options and visual
 * styles.
 *
  ...
  return (
    <div className="group mb-3 rounded-md py-2 transition-colors hover:bg-gray-50">
      <div className="flex items-center justify-between">
        ...
        <div className={cn('text-sm', monospace && 'font-mono text-xs')}>
              ...
              {isBadge && (
                <span
                  className={cn(
                    ...
                    getBadgeClass(badgeType as BadgeType)
                  )}
                >
                  {value}
                </span>
            ...
            >
              {isAmount && (
                <span
                  className={cn(
                    'font-medium',
                    getAmountClass(amountType as AmountType)
                  )}
                >
                  {value}
                </span>
