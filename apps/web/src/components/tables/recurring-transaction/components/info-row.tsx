 ...
 * @property isAmount - Whether this row displays a monetary amount that should
 *   be colored
 * @property amountType - The type of amount to determine color when isAmount is
 *   true
 */
...
/**
 * InfoRow component for displaying key-value pairs of information. Used
 * throughout detail views to consistently format information with various
 * display options.
 *
 * @example
 *   ```tsx
