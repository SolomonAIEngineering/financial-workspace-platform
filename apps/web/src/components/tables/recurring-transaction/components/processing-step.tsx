 ...
 */
export type ProcessingStepColorType = 'success' | 'info' | 'warning' | 'error' | 'purple' | 'default';

/**
 * Props for the ProcessingStep component
 * 
 * @property label - The name of the processing step
 * @property percentage - The percentage of time this step took relative to the whole process
...
/**
 * ProcessingStep component for visualizing processing steps with percentage bars.
 * Used to display relative time spent in each step of a process, such as transaction processing phases.
 * 
