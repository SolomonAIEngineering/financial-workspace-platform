...
export function TransactionSection({
    ...
    const getIconComponent = (type: SectionIconType) => {
        const iconMap: Record<SectionIconType, React.ReactNode> = {
            calendar: <Icons.Calendar className={iconVariants({ variant: 'calendar' })} />,
            bank: <Icons.Building2 className={iconVariants({ variant: 'bank' })} />,
            'credit-card': <Icons.CreditCard className={iconVariants({ variant: 'credit-card' })} />,
            receipt: <Icons.Receipt className={iconVariants({ variant: 'receipt' })} />,
            tag: <Icons.Tag className={iconVariants({ variant: 'tag' })} />,
            'pie-chart': <Icons.PieChart className={iconVariants({ variant: 'pie-chart' })} />,
            'alert-circle': <Icons.AlertCircle className={iconVariants({ variant: 'alert-circle' })} />,
            ...
            activity: <Icons.Activity className={iconVariants({ variant: 'activity' })} />,
            repeat: <Icons.Repeat className={iconVariants({ variant: 'repeat' })} />,
            'dollar-sign': <Icons.DollarSign className={iconVariants({ variant: 'dollar-sign' })} />,
            settings: <Icons.Settings className={iconVariants({ variant: 'settings' })} />,
            'file-text': <Icons.FileText className={iconVariants({ variant: 'file-text' })} />,
