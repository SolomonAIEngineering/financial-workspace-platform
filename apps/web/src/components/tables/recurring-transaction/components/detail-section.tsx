 ...
 * Provides a toggle-able section with an animated header and expandable content.
 * 
...
export function DetailSection({
    ...
    return (
        <div className={cn("mb-4 overflow-hidden rounded-lg border border-blue-100 bg-white shadow-sm", className)}>
            <button
                type="button"
                onClick={toggleOpen}
                className={cn(
            ...
            {isOpen && (
                <div className="divide-y divide-blue-50 px-4 py-3">
                    {children}
                </div>
            )}
        </div>
