...
/**
 * A component that displays a timeline of past and future recurring transactions
 */
export function TransactionTimeline({
    ...
    return (
        <div className="py-2">
            {/* History Section */}
            <div className="mb-4">
                <h4 className="mb-2 text-sm font-medium text-gray-700">Transaction History</h4>
                {historyDates.length > 0 ? (
                    <div className="space-y-3">
                        {historyDates.map((date, index) => (
                            <div key={`history-${index}`} className="flex items-center space-x-3">
            ...
            {/* Forecast Section */}
            <div>
                <h4 className="mb-2 text-sm font-medium text-gray-700">Upcoming Transactions</h4>
                {futureDates.length > 0 ? (
                        ...
                        {futureDates.map((date, index) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    index === 0 ? "opacity-100" : index === 1 ? "opacity-90" : "opacity-70"
                                )}
                            >
                    ...
                    <p className="text-sm text-gray-500">No upcoming transactions forecasted</p>
                )}
            </div>
        </div>
    );
