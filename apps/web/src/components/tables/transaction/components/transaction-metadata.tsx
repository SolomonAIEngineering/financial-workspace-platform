...
export function TransactionMetadata({
    ...
    return (
        <div className="rounded-lg border-4 border-gray-50 bg-card/60 shadow-sm p-[2.5%] mt-4">
            <h3 className="text-sm font-medium mb-3 text-muted-foreground">Transaction Metadata</h3>
