...
/**
 * EditableDetailRow component - Renders an editable form field for transaction details.
 *
 * This component is used in edit mode to allow users to modify transaction data. It
 * supports text inputs, textareas for longer content, select dropdowns for fields
 * with predefined options, and custom inputs via children.
 *
 ...
 * @param {boolean} [props.isTextarea] - If true, renders a textarea instead of input
 * @param {boolean} [props.isSelect] - If true, renders a select dropdown
 * @param {boolean} [props.isBoolean] - If true, renders a switch for boolean values
            ...
            {hasCustomInput ? (
                ...
                <div className="flex items-center space-x-2">
                    <Switch
                        ...
                        onCheckedChange={(checked) => {
                            console.log(`Boolean change for ${label}:`, checked);
                ...
                <Select
                    ...
                    onValueChange={(newValue) => {
                        console.log(`Select change for ${label}:`, newValue);
                ...
                <Textarea
                    ...
                    value={value as string}
                    onChange={(e) => {
                        console.log(`Textarea change for ${label}:`, e.target.value);
