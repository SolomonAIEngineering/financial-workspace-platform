 ...
 */
export function formatTransactionType(type?: string, isManual?: boolean, isRecurring?: boolean): string {
 ...
 */
export function getStatusBadgeType(status: string): 'default' | 'success' | 'warning' | 'error' | 'info' {
 ...
 */
export const categoryColors: Record<string, { dot?: string; icon?: React.ReactNode }> = {
