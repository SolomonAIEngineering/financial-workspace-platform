 ...
 * @property {React.ReactNode} children - The content to display inside the
 *   collapsible section.
 * @property {React.ReactNode} [icon] - Optional icon to display next to the
 *   section title.
 * @property {boolean} [defaultOpen=false] - Whether the section should be
 *   expanded by default. Default is `false`
 * @property {string} [className] - Optional additional CSS classes to apply to
 *   the section.
 * @property {string} [tooltip] - Optional tooltip text to display when hovering
 ...
 *
 * This component provides a consistent UI pattern for transaction details, with
 * accessibility features including tooltips for additional context. The
 * component has a collapsible behavior allowing users to expand/collapse
  ...
  return (
    <Collapsible
      ...
      className={cn(
        ...
        'mb-4 hover:bg-card hover:shadow-md md:p-[2.5%]',
        className
      )}
    >
      ...
      <CollapsibleContent className="animate-collapsible-down">
        <div className={cn('px-4 pt-4 pb-4', 'border-t border-border/40')}>
          {children}
        </div>
      </CollapsibleContent>
    </Collapsible>
