 ...
 *   -
 *
 *   The color scheme to use for styling the property item based on its semantic
 *   meaning. Default is `'default'`
...
/**
 * PropertyItem component - Displays a labeled boolean property with visual
 * indication.
 *
 * This component is used to show boolean properties/flags in a transaction with
 * consistent styling. Each property is displayed as a pill/chip with a label
 * and a checkmark or X icon to indicate true/false state. Optional tooltips
