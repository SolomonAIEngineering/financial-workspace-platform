 ...
 * 
 * This module exports a comprehensive record mapping transaction field names to human-readable
 * descriptions that explain the purpose and meaning of each field. These descriptions are used
 * in tooltips throughout the transaction details interface to provide context and help users
 * understand the significance of each data point.
 * 
 * The descriptions are organized by logical groupings to cover all aspects of a transaction:
...
export const fieldDescriptions: Record<string, string> = {
    ...
    merchantName: "Name of the merchant or counter-party involved in the transaction",
    ...
    needsWantsCategory: "Classification as 'need' or 'want' for budgeting purposes",
    ...
    // Payment Details
    paymentMethod: "Method used to make the payment (credit card, bank transfer, etc.)",
    ...
    excludeFromBudget: "Indicates if this transaction should be excluded from budget calculations",
    ...
    plaidTransactionId: "ID assigned by the Plaid service if imported through Plaid",
    ...
    originalDescription: "Original transaction description before any modifications",
