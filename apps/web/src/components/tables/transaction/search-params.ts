/**
 * Defines URL search parameter parsing logic for transactions. This file
 * handles the conversion between URL search parameters and strongly typed
...
/**
 * Configuration object for all search parameters used in transactions. Defines
 * how each parameter should be parsed from and serialized to URL search
 * parameters.
 *
 * Parameters include:
 *
