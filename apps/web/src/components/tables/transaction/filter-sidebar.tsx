 ...
 * @property contentClassName - Custom class name for the content area
 *   containing filters
...
/**
 * FilterSidebar component for the DataTable. Displays the filters and filter
 * controls for the data table. This component can be customized with className
 * props to adjust its layout.
 */
