...
import { Dialog, DialogDescription, DialogHeader, DialogTitle } from "@/registry/default/potion-ui/dialog";
...
export function SelectBankAccountsModal({
    ...
    const [accounts, setAccounts] = useState<APIFinancialAccountListResponse.Data[]>([]);
    ...
    const handleActiveTabChange = (value: "support" | "loading" | "select-accounts") => {
        setActiveTab(value);
    };
