 ...
 * 
 * A reusable tooltip component that displays helpful information when users hover over 
 * a question mark icon. Designed to provide contextual help and detailed explanations
 * for various UI elements throughout the application.
 * 
...
export interface InfoTooltipProps {
    ...
    /** 
     * Detailed description text to display in the tooltip.
     * Can include longer explanations and instructions.
     */
    description: string;
 ...
 * 
 * This component is useful for providing additional context or explanations
 * for fields, features, or actions in the user interface. It helps improve 
 * user experience by making information available on demand without cluttering
 * the interface.
 *
        ...
        <TooltipProvider>
            <Tooltip delayDuration={300}>
                <TooltipTrigger asChild>
                    <span className={cn(
                        "bg-background inline-flex cursor-help items-center justify-center rounded-full",
                ...
                <TooltipContent
                    ...
                    align={align}
                    className={cn(
                        "max-w-sm p-3 md:p-[3%] text-sm bg-background text-foreground md:min-w-[200px] md:min-h-[80px]",
                        contentClassName
                    )}
                >
                    {title && (
