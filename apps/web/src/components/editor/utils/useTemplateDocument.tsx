...
import { operatingAgreementValue } from '@/registry/default/example/legal-documents/operating-agreement';
import { partnershipAgreementValue } from '@/registry/default/example/legal-documents/partnership-agreement';
...
const templates: Record<string, TemplateDocument> = {
  ...
  'operating-agreement': {
    ...
    value: operatingAgreementValue,
  },
  'partnership-agreement': {
    id: 'partnership-agreement',
    icon: '🤝',
    title: 'Partnership Agreement',
    value: partnershipAgreementValue,
  },
  equation: {
    id: 'equation',
    icon: '🧮',
