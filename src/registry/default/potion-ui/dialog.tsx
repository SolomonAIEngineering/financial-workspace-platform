...
const dialogContentVariants = cva(
  cn(
    'fixed left-1/2 top-1/2 z-[101] flex w-full -translate-x-1/2 -translate-y-1/2 flex-col border bg-background shadow-lg shadow-black/5 focus-visible:ring-0'
  ),
  {
    defaultVariants: {
      minHeight: false,
    ...
    variants: {
      ...
      variant: {
        full: cn(
          'h-full max-w-full',
          'data-[state=closed]:duration-500 data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom data-[state=closed]:slide-out-to-left-1/2'
        ),
        modal: cn(
