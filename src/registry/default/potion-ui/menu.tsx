...
const menuItemVariants = cva(
  'group/menu-item relative flex min-h-[28px] select-none items-center justify-between gap-2 px-2.5 text-sm text-accent-foreground outline-hidden transition-bg-ease data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:size-4',
  {
    defaultVariants: {
      isEmpty: false,
      variant: 'default',
    ...
    variants: {
      isEmpty: {
        false:
          'cursor-pointer hover:bg-accent data-active-item:bg-accent data-active-item:text-accent-foreground aria-expanded:bg-accent aria-selected:bg-accent',
