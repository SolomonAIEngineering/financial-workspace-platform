...
import { ParsedMetricPeriod, SchemasType, schemas } from './types'
...
export const getTimestampFormatter = (
    ...
    switch (interval) {
        ...
        default:
            return (value: Date) => value.toLocaleDateString(locale, { dateStyle: 'medium' })
    }
}
...
export const metricDisplayNames: Record<keyof SchemasType['Metrics'], string> = {
    revenue: 'Revenue',
    orders: 'Orders',
