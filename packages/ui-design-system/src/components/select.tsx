...
>(({ className, children, hideIcon = false, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-border placeholder:text-muted-foreground !flex h-9 w-full items-center justify-between whitespace-nowrap border bg-transparent px-3 py-2 text-sm font-normal focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
