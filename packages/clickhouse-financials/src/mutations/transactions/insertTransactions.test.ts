...
describe('insertTransactions', () => {
    ...
    test(
      ...
      async (t) => {
        ...
        if (queryResult.val) {
          ...
          expect(queryResult.val[1].amount).toBe(200.0)
        } else {
  ...
  describe('Error Handling', () => {
    test('should handle database errors', { timeout: 60_000 }, async () => {
    ...
    test('should handle unexpected exceptions during insertion', async () => {
