...
describe('insertRecurringTransaction', () => {
    describe('Unit Tests', () => {
        ...
        beforeEach(() => {
            ...
            originalInsertRecurringTransactions = insertRecurringTransactionsModule.insertRecurringTransactions;
            ...
            vi.spyOn(insertRecurringTransactionsModule, 'insertRecurringTransactions').mockImplementation(() => {
                return mockInsertMultiple as unknown as (transactions: RecurringTransaction[]) => Promise<MutationResponse>;
            });
        });

        afterEach(() => {
            // Restore the original implementation
            vi.spyOn(insertRecurringTransactionsModule, 'insertRecurringTransactions').mockRestore();
        });
        ...
        test('should call insertRecurringTransactions with an array containing the single transaction', async () => {
            ...
            expect(insertRecurringTransactionsModule.insertRecurringTransactions).toHaveBeenCalledWith(mockInserter);
