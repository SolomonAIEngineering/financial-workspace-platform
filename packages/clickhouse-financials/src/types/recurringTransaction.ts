...
export type RecurringTransactionStatus = z.infer<typeof RecurringTransactionStatusEnum>;

/**
 * Enum for overspend action
 */
export const OverspendActionEnum = z.enum([
    'block',
    'notify',
    'proceed'
]);
 ...
 */
export const ImportanceLevelEnum = z.enum([
    'Critical',
    'High',
    'Medium',
    'Low'
