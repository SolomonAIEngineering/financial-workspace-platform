...
export const NEXT_PRIVATE_INTERNAL_WEBAPP_URL =
  process.env.NEXT_PRIVATE_INTERNAL_WEBAPP_URL ?? NEXT_PUBLIC_SITE_URL();
...
export const APP_BASE_URL = () =>
  IS_APP_WEB ? NEXT_PUBLIC_SITE_URL() : NEXT_PUBLIC_MARKETING_URL();

export const WEBAPP_BASE_URL = NEXT_PUBLIC_SITE_URL() ?? 'http://localhost:3000';
