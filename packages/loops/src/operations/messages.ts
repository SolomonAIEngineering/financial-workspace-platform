...
export async function sendEvent(
    ...
    return client.sendEvent({
        ...
        eventProperties: input.eventProperties as Record<string, string | number | boolean> | undefined
    });
}
...
export async function sendTransactionalEmail(
    ...
    return client.sendTransactionalEmail({
        ...
        dataVariables: input.dataVariables as Record<string, string | number> | undefined
    });
} 