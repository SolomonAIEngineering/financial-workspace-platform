...
import { PdfTemplate } from './index';

const meta = {
    title: 'Templates/PDF/Format',
    component: PdfTemplate,
    parameters: {
        layout: 'centered',
        docs: {
            description: {
                component: 'This story demonstrates the PDF formatting function which converts template props to PDF',
            },
        },
    },
} satisfies Meta<typeof PdfTemplate>;
...
const pdfElement = formatEditorContent(editorDoc);
`,
            },
        },
    },
    render: () => {
        ...
        // In a real scenario, formatEditorContent would return a PDF element
        // which would be used in PDF generation
        return <PdfTemplate {...mockTemplateProps} />;
    },
}; 