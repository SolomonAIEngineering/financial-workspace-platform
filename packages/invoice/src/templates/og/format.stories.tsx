...
import { OgTemplate } from './index';

const meta = {
    title: 'Templates/OG/Format',
    component: OgTemplate,
    parameters: {
        layout: 'centered',
        docs: {
            description: {
                component: 'This story demonstrates the OG image formatting function which converts editor content to Open Graph image elements',
            },
        },
    },
} satisfies Meta<typeof OgTemplate>;
...
const ogElement = formatEditorContent(editorDoc);
`,
            },
        },
    },
    render: () => {
        ...
        // In a real scenario, formatEditorContent would return React elements
        // which would be used to generate the OG image
        return <OgTemplate {...mockTemplateProps} />;
    },
}; 