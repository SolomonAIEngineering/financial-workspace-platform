...
export function ZoomableChart({
  ...
  return (
    <Card className="h-full w-full">
      <CardHeader className="hidden flex-col items-stretch space-y-0 border-b p-0 sm:flex sm:flex-row">
        ...
        <div className="flex">
          <div className="bg-muted/10 relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-l sm:border-l sm:border-t-0 sm:px-8 sm:py-6">
      ...
      <CardContent
        className={cn('h-full px-2 sm:h-[calc(100%-150px)] sm:p-6', className)}
      >
            ...
            <ResponsiveContainer width="100%" height={400}>
              ...
              >
                ...
                <ChartTooltip
                  ...
                  content={
                    <ChartTooltipContent
                      className="w-[150px] font-mono text-xs sm:w-[200px] sm:text-sm"
                      nameKey={dataNameKey}
      ...
      {footerDescription && (
        <CardFooter className="text-muted-foreground border-t p-[3%] text-sm">
          {footerDescription}
        </CardFooter>
      )}
    </Card>
