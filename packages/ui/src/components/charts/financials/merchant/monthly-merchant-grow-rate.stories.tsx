...
} from "./monthly-merchant-grow-rate";
...
export default {
    component: MonthlyMerchantGrowthRateChart,
    parameters: {
        layout: "centered",
    },
    argTypes: {
...
const Template: StoryFn<MonthlyMerchantGrowthRateChartProps> = (
    args: JSX.IntrinsicAttributes & MonthlyMerchantGrowthRateChartProps,
) => (
    <div className="w-[900px]">
        <MonthlyMerchantGrowthRateChart {...args} />
    </div>
);
