...
Default.args = {
  ...
  description:
    'Join thousands of businesses that are using our platform to streamline their financial management process.',
  children: (
...
WithCustomButtons.args = {
  ...
  description:
    'Our AI-powered platform helps you make smarter financial decisions with real-time insights and analytics.',
  children: (
    <div className="mt-6 flex flex-col gap-4 sm:flex-row">
      <Button
        variant="default"
