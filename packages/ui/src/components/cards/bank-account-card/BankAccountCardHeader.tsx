  ...
  return (
    <CardHeader className="grid grid-cols-[1fr_110px] items-start gap-4 space-y-0">
      <div className="space-y-1 text-left">
        <CardTitle className="text-background dark:text-foreground text-xs font-bold">
          $
        ...
        <div>
          <div className="flex flex-1 justify-start gap-2">
            <Badge
              className="bg-background text-foreground rounded-2xl border border-black px-2 font-bold"
              style={{
                fontSize: '10px',
              }}
              variant={'outline'}
