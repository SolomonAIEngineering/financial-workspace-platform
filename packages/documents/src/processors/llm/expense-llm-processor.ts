...
const lineItemSchema = z.object({
  ...
  totalPrice: z
    .number()
    .describe('The total price for this line item (quantity * price).'),
})
...
const expenseSchema = z.object({
  name: z
    .string()
    .describe('The supplier or company name associated with the expense.'),
  ...
  currency: z
    .string()
    .describe('The three-letter currency code of the expense (e.g. USD, EUR).'),
  description: z
    .string()
    .describe(
  ...
  paymentMethod: z
    ...
    .optional()
    .describe(
      'The payment method used (e.g. credit card, cash), if identifiable.',
    ),
  subtotal: z
    .number()
    .optional()
    .describe('The subtotal amount before tax, if available.'),
  tax: z
    .number()
    .optional()
    .describe('The total tax amount included in the purchase, if available.'),
  tip: z
    .number()
    .optional()
    .describe('The tip amount included in the purchase, if any.'),
  lineItems: z
    .array(lineItemSchema)
    .optional()
    .describe(
      'An array of line items detailing individual purchased goods or services.',
    ),
})
