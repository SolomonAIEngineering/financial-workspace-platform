...
export interface Comment {
  ...
  viewsByUser: Record<string, unknown> | null
  ...
  moderationHistory: Record<string, unknown> | null
...
export type FollowStatus = 'NONE' | 'FOLLOWING' | 'MUTED' | 'BOOKMARKED'

export declare const FollowStatus: {
  readonly NONE: 'NONE'
...
export type MentionType = 'USER' | 'TEAM' | 'ALL' | 'ROLE' | 'CUSTOM'
...
declare global {
  ...
  export type TReaction = Reaction
  export type TMention = Mention
  ...
  export type TFollowStatus = FollowStatus
  export type TSentimentType = SentimentType
  export type TMentionType = MentionType
